...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:Aaron040222@localhost:5432/lab5'
...
def newpost():
    ...
    if request.method == 'POST':
        ...
        # Create in DB
        new_post = Post(author=session_user.username, content=content, creation_date=creation_date)
